...
function refresh () {
	...
	document.forms['gpa_info'].elements['gpa'].value = null;
	document.forms['gpa_info'].elements['doned'].value = null;
	
	document.forms['forrm'].elements['grade_1'].value = "";
	document.forms['forrm'].elements['grade_gp_1'].value = "";
	document.forms['forrm'].elements['points_1'].selected = "";
	document.forms['forrm'].elements['gp_1'].value = "";
	
	document.forms['forrm'].elements['grade_2'].value = "";
	document.forms['forrm'].elements['grade_gp_2'].value = "";
	document.forms['forrm'].elements['grade_3'].value = "";
	document.forms['forrm'].elements['grade_gp_3'].value = "";
	document.forms['forrm'].elements['grade_4'].value = "";
	document.forms['forrm'].elements['grade_gp_4'].value = "";
	document.forms['forrm'].elements['grade_5'].value = "";
	document.forms['forrm'].elements['grade_gp_5'].value = "";
	document.forms['forrm'].elements['grade_6'].value = "";
	document.forms['forrm'].elements['grade_gp_6'].value = "";
	document.forms['forrm'].elements['grade_7'].value = "";
	document.forms['forrm'].elements['grade_gp_7'].value = "";
	document.forms['forrm'].elements['grade_8'].value = "";
	document.forms['forrm'].elements['grade_gp_8'].value = "";
	document.forms['forrm'].elements['grade_9'].value = "";
	document.forms['forrm'].elements['grade_gp_9'].value = "";
	document.forms['forrm'].elements['grade_10'].value = "";
	document.forms['forrm'].elements['grade_gp_10'].value = "";
	document.forms['forrm'].elements['grade_11'].value = "";
	document.forms['forrm'].elements['grade_gp_11'].value = "";
	document.forms['forrm'].elements['grade_12'].value = "";
	document.forms['forrm'].elements['grade_gp_12'].value = "";
	document.forms['forrm'].elements['grade_13'].value = "";
	document.forms['forrm'].elements['grade_gp_13'].value = "";
	document.forms['forrm'].elements['grade_14'].value = "";
	document.forms['forrm'].elements['grade_gp_14'].value = "";
	document.forms['forrm'].elements['grade_15'].value = "";
	document.forms['forrm'].elements['grade_gp_15'].value = "";
	...
	document.forms['forrm'].elements['sum_credit_hours'].value = "";
	document.forms['forrm'].elements['sum_grade_points'].value = "";
	document.forms['forrm'].elements['term_gpa'].value = "";
	document.forms['forrm'].elements['cumulative_gpa'].value = "";
	document.forms['forrm'].elements['status'].value = "";
	document.forms['forrm'].elements['remarks'].value = "";
}